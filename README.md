<p align="center">
  <img src="./logoN.png" alt="HackMate Logo" width="140" />
</p>

<h1 align="center">HackMate</h1>
...
## 🚀 What Inspired Us to Build HackMate
...
That’s when the idea struck: *what if there was a platform built by developers, for developers, to match teammates based on real tech skills and interests?* That’s how HackMate was born.

---

## 🎯 What Is HackMate?

*HackMate* is a full-stack platform that helps developers:
...
| *API Handling* | Axios 🔗 |
| *End-to-End Encryption* | Web Crypto API 🕵 + AES + RSA 🔒 |
| *Payments* | RazorPay 💳 + Web Hook 🔁 |
| *Real-time Chat* | WebSocket 🌐 + SockJS 🔌 + STOMP 🗨 |
| *Caching* | Redis 🧊 |
...
We welcome developers of all backgrounds. Whether you love frontend, backend, DevOps, or ML—there’s a place for you in HackMate!
